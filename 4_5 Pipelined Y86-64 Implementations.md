...
| Stage     | OPq rA,rB                                                                | irmovq V,rB                                                                                   | 0x00a: irmovq $3,%rax<br>V  = $3<br>rB = %rax                                                         | addq %rdx,%rax<br>rA = %rdx<br>rB = %rax                                 |
| --------- | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Fetch     | $icode :ifun ← M_1[PC]$<br>$rA :rB ← M_1[PC + 1]$<br><br>$valP ← PC + 2$ | $icode :ifun ← M_1[PC]$<br>$rA :rB ← M_1[PC + 1]$<br>$valC ← M_8[PC + 2]$<br>$valP ← PC + 10$ | $icode :ifun ← M_1[PC]$<br>$rA :rB ← M_1[PC + 1]$<br>$D\_valC ← M_8[PC + 2]=3$<br>$D\_valP ← PC + 10$ | $icode :ifun ← M_1[PC]$<br>$rA :rB ← M_1[PC + 1]$<br><br>$valP ← PC + 2$ |
| Decode    | $valA ← R[rA]$<br>$valB ← R[rB]$                                         | -                                                                                             | $E\_valC ← D\_valC$<br>$E\_dstE←D\_dstE$                                                              | $valA ← R[rA]$<br>$valB ← R[rB]$                                         |
| Execute   | $valE ← valB~OP~valA$<br>$Set~CC$                                        | $valE ← 0 + valC$                                                                             | $M\_valE ← 0 + E\_valC ~= 3$<br>$M\_dstE←E\_dstE$                                                     | $valE ← valB~OP~valA$<br>$Set~CC$                                        |
| Memory    | -                                                                        | -                                                                                             | W_valE <- M_valE = 3<br>W_dstE <- M_dstE                                                              | -                                                                        |
| Writeback | $R[rB] ← valE$                                                           | $R[rB] ← valE$                                                                                | %rax <- W_valE                                                                                        | $R[rB] ← valE$                                                           |
