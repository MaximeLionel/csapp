...
| Stage     | 0x014: rmmovq %rcx, 0(%rdx)<br>rmmovq rA, D(rB)<br>rA = %rcx<br>D  = 0<br>rB = %rdx  | 0x00a: irmovq $3,%rax<br>irmovq V,rB<br>V  = $3<br>rB = %rax                                          | 0x016: addq %rdx,%rax<br>OPq rA,rB<br>rA = %rdx<br>rB = %rax                                                                                             |
| --------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fetch     | icode:ifun ← M1[PC]<br>rA:rB ← M1[PC + 1]<br>D_valC ← M8[PC + 2]<br>D_valP ← PC + 10 | $icode :ifun ← M_1[PC]$<br>$rA :rB ← M_1[PC + 1]$<br>$D\_valC ← M_8[PC + 2]=3$<br>$D\_valP ← PC + 10$ | $icode :ifun ← M_1[PC]$<br>$rA :rB ← M_1[PC + 1]$<br><br>$valP ← PC + 2$                                                                                 |
| Decode    | E_valA ← R[rA]<br>E_valB ← R[rB]<br>                                                 | $E\_valC ← D\_valC$<br>$E\_dstE←D\_dstE=\%rax$                                                        | $E\_valA ← R[\%rdx]$:<br> - d_srcA = %rdx<br> - E_valA <- d_rvalA<br>$E\_valB ← R[\%rax]$:<br> - d_srcB = %rax<br> - E_valB <- d_rvalB<br>E_dstE <- %rax |
| Execute   | $M\_valE ← 0 + E\_valC~=128$<br>$M\_dstE←E\_dstE=\%rdx$                              | $M\_valE ← 0 + E\_valC ~= 3$<br>$M\_dstE←E\_dstE=\%rax$                                               | M_valE <- E_valB + E_valA<br>M_dstE <- E_dstE = %rax<br>Set CC                                                                                           |
| Memory    | W_valE <- M_valE = 128<br>W_dstE <- M_dstE = %rdx                                    | W_valE <- M_valE = 3<br>W_dstE <- M_dstE = %rax                                                       | W_valE <- M_valE<br>W_dstE <- M_dstE = %rax                                                                                                              |
| Writeback | W_dstE = %rdx<br>W_valE = 128<br>%rdx <- W_valE = 128                                | W_dstE = %rax<br>W_valE = 3<br>%rax <- W_valE = 3                                                     | %rax <- W_valE                                                                                                                                           |
